...
# $Id: bunzip2.pm,v 1.2 2001/09/01 17:13:41 rich Exp $
...
=head1 SYNOPSIS
  ...
  # then you can read bunzip2-compressed bytes from $fio

  $io = ...; # any IO handle
  $fio = new IO::Filter::bunzip2 ($io, "w");
...
=item $fio = new IO::Filter::bunzip2 ($io, $mode);
...
sub new
  {
    ...
    my $self = $class->SUPER::new ($io, $mode, "bzip2", "-cd");
